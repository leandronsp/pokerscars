...
config :pokerscars, PokerscarsWeb.Endpoint,
  ...
  http: [ip: {0, 0, 0, 0}],
  # Inside the container the app listens on 4000, but the browser reaches it
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:pokerscars, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:pokerscars, ~w(--watch)]}
  ]
...
config :pokerscars, dev_routes: true
